 ...
 * Validates field availability, checks for overlapping bookings, calculates price
 */
export const createBooking = async (req: Request, res: Response) => {
  try {
    ...
    const { id: customerId } = verifyToken(token);
    ...
    const totalPrice = field.price_per_hour.toNumber() * parseInt(duration);
